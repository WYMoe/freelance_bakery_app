...
import 'package:freelance_demo/screens/totalSale_screens/totalSaleProductUploadHistory.dart';
import 'package:intl/intl.dart';
import 'package:freelance_demo/models/totalSale_models/totalSaleVocher.dart';

class TotalSaleHistory extends StatefulWidget {
  @override
  _TotalSaleHistoryState createState() => _TotalSaleHistoryState();
}

class _TotalSaleHistoryState extends State<TotalSaleHistory> {
  @override
  void initState() {
    super.initState();

    // String strDt = "2000-07-01 00:00:00Z";
    // DateTime parseDt = DateTime.parse(strDt);
    // print(parseDt); // 1984–04–02 00:00:00.000

    // Timestamp timestamp = Timestamp.fromDate(parseDt);
    // print(timestamp);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('အရောင်းစာရင်း : History'),
          centerTitle: false,
        ),
        body: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              snapshot.data.documents.forEach((doc) {
                TotalSaleVocher vocher = TotalSaleVocher.fromDocument(doc);
                  ...
                  vocherTiles.add(FlatButton(
                    onPressed: () {
                      Navigator.push(context,
                        ...
                        return TotalSaleProductUploadHistory(
                          vocherID: vocher.vocherID,
                          createdDate: vocher.createdDate.toDate(),
                          total: vocher.total,
                          creator: vocher.creator,
                        );
                      }));
                    },
                    onLongPress: () {
  ...
  Future<void> _showMyDialog(TotalSaleVocher vocher) async {
                  ...
                  children: <Widget>[
                    Text(
                      DateFormat('yyyy-MM-dd')
                          .format(vocher.createdDate.toDate()),
                      style: TextStyle(
